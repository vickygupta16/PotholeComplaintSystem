...
@section('content')
    <div class="container" align="center">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card" style="height:32rem; width: 18rem;">
                    <img height=50% class="card-img-top" src="{{URL::to('assets/images/eye_icon.jpeg')}}" alt="Card image cap">
            ...
            <div class="col-md-6">
                <div class="card" style="height:32rem; width: 18rem;">
                    <img height=50% class="card-img-top" src="{{URL::to('assets/images/graph_icon.png')}}" alt="Card image cap">
                    <hr style="width:90%;background-color:black">
                    <div style="background-color:black" class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card" style="height:30rem; width: 18rem;">
                    <img height=50% class="card-img-top" src="{{URL::to('assets/images/adddel_icon.jpg')}}" alt="Card image cap">
                    <hr style="width:90%;background-color:black">
                    <div style="background-color:black" class="card-body">
            ...
            <div class="col-md-6">
                <div class="card" style="height:30rem; width: 18rem;">
                    <img height=50% class="card-img-top" src="{{URL::to('assets/images/delua_icon.png')}}" alt="Card image cap">
                    <hr style="width:90%;background-color:black">
                    <div style="background-color:black" class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card" style="height:30rem; width: 18rem;">
                    <img height=50% class="card-img-top" src="{{URL::to('assets/images/adddel_ward.png')}}" alt="Card image cap">
                    <hr style="width:90%;background-color:black">
                    <div style="background-color:black" class="card-body">
            ...
            <div class="col-md-6">
                <div class="card" style="height:30rem; width: 18rem;">
                    <img height=50% class="card-img-top" src="{{URL::to('assets/images/sug.png')}}" alt="Card image cap">
                    <hr style="width:90%;background-color:black">
                    <div style="background-color:black" class="card-body">
