...
<?php $__env->startSection('content'); ?>
    <div align="center" class="container">
        ...
        <hr style="width:70%">
        <hr style="width:80%">
        <?php echo Form::open(['action' => 'SuggestionController@store','method'=>'POST']); ?>
            ...
            <div class="form-group">
                <?php echo e(Form::label('content','FeedBack')); ?>

                <?php echo e(Form::textarea('content','',['class'=>'form-control','rows'=>2])); ?>

            </div>
            <div class="form-group">
                <?php echo e(Form::label('stars','How much STAR/S would you like to give us?')); ?>
            ...
            <?php echo e(Form::submit('Submit',['class'=>'btn btn-lg btn-success'])); ?>
